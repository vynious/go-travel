            ...
            <div class="container px-6 py-8 mx-auto">
                ...
                <div class="flex flex-col items-center sm:flex-row sm:justify-between">
                    ...
                    <div class="flex -mx-2">
                        ...
                        <a href="https://github.com/vynious" class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
                            <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                                xmlns="https://github.com/vynious">
                                <path
